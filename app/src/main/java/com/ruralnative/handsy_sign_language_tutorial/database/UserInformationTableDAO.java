...
public class UserInformationTableDAO {
    ...
    public void addUser(UserInformationTableModel user) {
        ...
        database.insert(userInformationTable, null, values);
        database.close();
    }
    ...
    public UserInformationTableModel getUserById(int id) {
        ...
        try (Cursor cursor = database.query("users", userInformationColumns,
